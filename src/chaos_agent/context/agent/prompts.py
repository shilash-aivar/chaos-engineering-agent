...
2. If declared context exists (Terraform, README, manifests), fetch and compare to observed.
   If declared context is missing and GitHub is connected, call pull_github_context and then re-check declared context.
...
- If a service scope is provided, focus tools and summary on that service and its direct dependencies.
